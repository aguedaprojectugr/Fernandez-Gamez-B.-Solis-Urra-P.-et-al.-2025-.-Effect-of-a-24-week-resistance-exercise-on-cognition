# ---- 1. Load Data and Fit Model, Analysis including midpoint ----
...
## ---- Extract Model Summary and Group Differences ----
...
## ---- Duplicate “All” rows so each timepoint has matching rows ----
...
## ---- Assign Group Labels (Control vs Exercise) ----
...
## ---- Merge EMM with Group Differences ----
...
# ---- 2. pS4a: Estimated Marginal Means Plot ----

Fig_S4a = ggplot(table_plot, aes(x = redcap_event_name, y = emmean)) +
  ...
  # Group difference annotations for Mid and Post
  geom_text(
    data = table_plot %>%
...
# ---- 3. pS4b: Individual Trajectories + Raincloud Plot ----

devtools::source_url(
  "https://raw.githubusercontent.com/yjunechoe/geom_paired_raincloud/master/geom_paired_raincloud.R"
)

Fig_S4b = ggplot(data, aes(redcap_event_name, comp_ex_func_mean_z, fill = rand_group)) +
...
# ---- 4. Save Figure S4 (Panels A + B) ----

agg_tiff(
  "04_supplementary/figures/Figure_S4_600.tiff",
